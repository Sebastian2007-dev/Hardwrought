...
public final class SurvivalHud {
    private static final KeyMapping.Category CATEGORY = KeyMapping.Category.register(Hardwrought.id("survival"));
    ...
    private static void renderDetails(net.minecraft.client.gui.GuiGraphicsExtractor graphics,
        ...
        graphics.text(client.font, I18n.get("hud.hardwrought.temperature"), x, y + 34,
                0xFFE8EDF0, true);
        temperatureBar(graphics, x, y + 46, width, values.bodyTemperature());
